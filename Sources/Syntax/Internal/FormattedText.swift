...
extension FormattedText {
    ...
    fileprivate struct Parser {
        ...
        private mutating func addPendingTextIfNeeded(
            trimmingWhitespaces trimWhitespaces: Bool = false
        ) {
                ...
                markerIteration: for marker in activeStyleMarkers {
                    ...
                    case .bold:
                        ...
                        if let otherMarker = italicMarker {
                            guard
                                marker.characterRange.lowerBound
                                    != otherMarker.characterRange.upperBound
                            else {
                                italicMarker = nil
